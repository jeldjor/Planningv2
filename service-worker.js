...
'use strict';
const CACHE='planyx-shell-v11.4.6-courier-r1';
const SHELL=['./','./index.html','./laptop.html','./mobile.html','./manifest.webmanifest','./auth.js','./auth.js?v=114600','./app-config.js','./planning-core.js','./planning-core.js?v=114600','./courier.js','./courier.js?v=114600','./courier.css','./courier.css?v=114600','./visit-pdf.js','./photo-zip.js','./assets/chain-banners.png','./assets/chain-banners-core.png','./assets/icons/apple-touch-icon.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./v108.js?v=114600','./v11.js','./v11.js?v=114600','./v11.css','./v113.js','./v113.js?v=114600','./v113.css','./v114.js','./v114.css','./brand.css','./planyx-brand.jpeg','./planyx-login-transparent.png','./gj-motion-brand.png'];
