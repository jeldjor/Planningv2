...
'use strict';
const CACHE='planyx-shell-v11.3.8-r2-unplanned-date-persistence';
const SHELL=['./','./index.html','./laptop.html','./mobile.html','./manifest.webmanifest','./auth.js','./app-config.js','./planning-core.js','./visit-pdf.js','./photo-zip.js','./assets/chain-banners.png','./assets/chain-banners-core.png','./assets/icons/apple-touch-icon.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./v11.js','./v11.css','./v113.js','./v113.css','./v114.js','./v114.css','./brand.css','./planyx-brand.jpeg','./planyx-login-transparent.png','./gj-motion-brand.png'];
