...
Deze functies leveren de twee beveiligde serverfuncties van v11.2.0:
...
Na iedere wijziging van de routecode moet minimaal `tomtom-proxy` opnieuw worden gedeployd:

```bash
supabase login
supabase link --project-ref <jouw-project-ref>
supabase functions deploy tomtom-proxy
```

Alleen bestanden naar GitHub uploaden werkt de al gedeployde Edge Function niet bij.
