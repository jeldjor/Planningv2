...
test('v11.3 gebruikt een stabiele invoerhash en hergebruikt ongewijzigde groene routes',()=>{
  assert.equal(core.VERSION,'11.4.6');assert.equal(JSON.parse(pkg).version,'11.4.6');
...
test('datumvelden blijven compact naast elkaar en release-assets worden gedeployed',()=>{
  ...
  assert.match(laptop,/v113\.css\?v=113001/);assert.match(laptop,/v113\.js\?v=114600/);
  assert.match(mobile,/v113\.js\?v=114600/);assert.match(build,/'v113\.js', 'v113\.css'/);
