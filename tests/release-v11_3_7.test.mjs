...
test('Planyx heeft een geldig standalone PWA-manifest',()=>{
  ...
  assert.match(manifest.start_url,/index\.html\?v=114600/);
...
test('alle app-ingangen bieden PWA- en iPhone-metadata aan',()=>{
  for(const file of ['index.html','mobile.html','laptop.html']){
    ...
    assert.match(html,/rel="manifest" href="manifest\.webmanifest\?v=114600"/);
    assert.match(html,/rel="apple-touch-icon" sizes="180x180" href="assets\/icons\/apple-touch-icon\.png\?v=114600"/);
